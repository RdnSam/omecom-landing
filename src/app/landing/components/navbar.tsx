...
import { Menu, ShoppingBag, ChevronDown, X, Moon, Sun } from 'lucide-react'
...
const navigationItems = [
  ...
  { name: 'Produk & Layanan', href: '#features', hasMegaMenu: true },
  { name: 'Tim', href: '#team' },
...
// Products menu items for mobile
const solutionsItems = [
  ...
  { name: 'Shopee Store', href: '#ecommerce' },
  { name: 'Tokopedia Store', href: '#ecommerce' },
  { title: 'Informasi' },
            ...
            <div className="flex flex-col h-full">
              ...
              <SheetHeader className="space-y-0 p-4 pb-2 border-b">
                <div className="flex items-center gap-2">
                  ...
                  <SheetTitle className="text-lg font-semibold">PT. Omecom</SheetTitle>
