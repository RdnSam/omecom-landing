...
export function CommandSearch({ open, onOpenChange }: CommandSearchProps) {
  ...
  const searchItems: SearchItem[] = [
    // Dashboards (Admin)
    { title: "Dashboard 1", url: "/admin/dashboard", group: "Dashboards", icon: LayoutDashboard },
    { title: "Dashboard 2", url: "/admin/dashboard-2", group: "Dashboards", icon: LayoutPanelLeft },

    // Apps (Admin)
    { title: "Mail", url: "/admin/mail", group: "Apps", icon: Mail },
    { title: "Tasks", url: "/admin/tasks", group: "Apps", icon: CheckSquare },
    { title: "Chat", url: "/admin/chat", group: "Apps", icon: MessageCircle },
    { title: "Calendar", url: "/admin/calendar", group: "Apps", icon: Calendar },
    ...
    // Settings (Admin)
    { title: "User Settings", url: "/admin/settings/user", group: "Settings", icon: User },
    { title: "Account Settings", url: "/admin/settings/account", group: "Settings", icon: Settings },
    { title: "Plans & Billing", url: "/admin/settings/billing", group: "Settings", icon: CreditCard },
    { title: "Appearance", url: "/admin/settings/appearance", group: "Settings", icon: Palette },
    { title: "Notifications", url: "/admin/settings/notifications", group: "Settings", icon: Bell },
    { title: "Connections", url: "/admin/settings/connections", group: "Settings", icon: Link2 },

    // Pages (Admin)
    { title: "FAQs", url: "/admin/faqs", group: "Pages", icon: HelpCircle },
    { title: "Pricing", url: "/admin/pricing", group: "Pages", icon: CreditCard },
  ]
